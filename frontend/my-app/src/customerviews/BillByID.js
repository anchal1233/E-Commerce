...
function BillById(props)
{
    ...
    useEffect(()=>{
        //get bill id from db
        axios.get("http://localhost:9995/bill/billshowbillids/"+props.data).then((res)=>{
            setBillIdList(res.data);
        }).catch((err)=>{
            alert(err);
        })
        //get product details from db
        axios.get("http://localhost:9995/product/showproduct")
        .then((res)=>{
            setPList(res.data);
        }).catch((err)=>{
            alert(err);
    ...
    const handleBillSelect=(evt)=>{
        axios.get("http://localhost:9995/bill/showbillbyid/"+evt.target.value).then((res)=>{
