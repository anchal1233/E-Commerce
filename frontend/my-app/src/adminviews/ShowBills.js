...
function ShowBills()
{
    ...
    useEffect(()=>{
        ...
        axios.get("http://localhost:9995/customer/getcustomerlist").then((res)=>{
        ...
        axios.get("http://localhost:9995/paymentdetails/showpaymentdetails").then((res)=>{
        }).catch((err)=>{
            alert(err);
        });
    },[])
    const handleCustomerSelect=(evt)=>{
        axios.get("http://localhost:9995/bill/billshow/"+evt.target.value).then((res)=>{
                    ...
                    </tr>
                    {
                        setBillDetailsList.map((bitem)=>(
                            <tr style={{backgroundColor:"beidge"}}>
                                ...
                                <td>{oprice}</td>
                                <td>
                                    <img src={"http://localhost:9995/product/getproductimage"+picname} height="100" width="100"/>
