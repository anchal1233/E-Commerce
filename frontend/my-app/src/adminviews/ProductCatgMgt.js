...
//save product code
        ...
        axios.post("http://localhost:9995/productcatg/addproductcatg/"+obj.pcatgid+
    ...
    //for show product
    useEffect( () => {
            axios.get("http://localhost:9995/productcatg/showproductcatg/")
            .then((res) => {
        ...
        const handleSearchButton=()=>{
            axios.get("http://localhost:9995/productcatg/searchproductcatg/"+pcatgid).then((res)=>{
       ...
       // for update product
        const handleUpdateButton=()=>{
            ...
            axios.post("http://localhost:9995/productcatg/editproductcatg/",obj)
            .then((res)=>{
                alert(res.data);
            }).catch((err)=>{
                alert(err);
        ...
        const handleDeleteButton=()=>{
            axios.delete("http://localhost:9995/productcatg/deleteproductcatg/"+pcatgid).then((res)=>{
                setPcatgId("");
                setPcatgName("");
                alert(res.data);
            }).catch((err)=>{
