...
const stv=multer.diskStorage({
    destination:(req,file,cb)=>{
        cb(null,"C:/Users/anchal mishra/Desktop/Universal drive files/html programs/web pages/E-Commerce/backend/SERVER-APP/product/productimages")
    },
...
productRoute.route('/getproductimage/:picname').get((req,res)=>{
    res.sendFile('C:/Users/anchal mishra/Desktop/Universal drive files/html programs/web pages/E-Commerce/backend/SERVER-APP/product/productimages'+req.params.picname);
});
