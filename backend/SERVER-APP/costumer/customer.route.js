...
customerRoute.route('/getimage/:cpicname').get((req, res) => {
    res.sendFile('C:/Users/anchal mishra/Desktop/Universal drive files/html programs/web pages/E-Commerce/backend/SERVER-APP/costumer/customerImage/' + req.params.cpicname);
});

//image save
const st = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, 'C:/Users/anchal mishra/Desktop/Universal drive files/html programs/web pages/E-Commerce/backend/SERVER-APP/costumer/customerImage/')
    },
